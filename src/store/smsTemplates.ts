...
const SMS_TEMPLATE_KEYS: TSmsTemplateKey[] = [
  "newOrderDelivery",
...
const DEFAULT_TEMPLATES: TSmsTemplates = {
  newOrderDelivery: `Děkujeme za Vaši objednávku #orderId
Doprava od 20 do 90 min.
Podpora: +420792745116`,
  newOrderDeliveryCustomDeliveryTime: `Děkujeme za Vaši objednávku #orderId
Doprava v orderDeliveryTime
Podpora: +420792745116`,
  newOrderPickup: `Děkujeme za Vaši objednávku #orderId
Připravíme od 20 do 60 min.
Adresa: orderPickupAddress
Podpora: +420792745116`,
  newOrderPickupCustomDeliveryTime: `Děkujeme za Vaši objednávku #orderId
Připravíme v orderDeliveryTime
Adresa: orderPickupAddress
Podpora: +420792745116`,
  orderIsOnTheWay: `Kurýr vyzvedl objednávku #orderId, a už na cestě k Vám.
Nechte recenze na Google: https://g.page/r/CdobvlNd2i7rEBM/review
Prejeme Vam dobrou chut <3`,
  orderIsReadyToPickup: `Objednávka #orderId připravena k vyzvednutí, a čeká na Vás.
...
const smsTemplates = {
  getAll: async (): Promise<TSmsTemplates> => {
    ...
    return SMS_TEMPLATE_KEYS.reduce<TSmsTemplates>(
      (accumulator: TSmsTemplates, key: TSmsTemplateKey): TSmsTemplates => ({
        ...accumulator,
        [key]: overrides?.[key] ?? DEFAULT_TEMPLATES[key],
      }),
      {} as TSmsTemplates,
    );
  },
...
export { SMS_TEMPLATE_KEYS, smsTemplates };
